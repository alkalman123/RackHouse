...
Written to sound like you sharing something you made, not an ad. Edit
freely — swap in your own voice, your own photos of the real prints once
you have them (the site's rendered photos are great for the shop itself,
but a real photo/video of the actual printed object in your hands will
outperform them on social every time). Swap `[link]` for your shop URL.
...
> First one's out in the wild 🙌 [tag them, with permission]
>
> Nothing fake on this site — no reviews, no ratings, until they're real.
> This is the first real one. Thank you [@handle].

*This matters more than it looks like it should — the shop deliberately
launched with zero fabricated reviews (see `README.md`), so
your first genuine customer photo is your actual first proof, and it'll
read as more credible for exactly that reason.*
...
- **Instagram feed / carousel:** first slide = the product alone on a
  clean background (the site's product photography works well here
  too); second/third slide = it in actual use; last slide = the price +
  "link in bio."
- **Reels / TikTok:** the strongest version of this content is almost
  always "here's the problem, here's the object, here's it in use" in
  under 15 seconds — resist the urge to over-explain in the video; put
  the explanation in the caption instead.
- **Stories:** a poll ("which color?") or a countdown sticker to launch
  is low-effort, high-engagement, and gives you a warm list of people to
  DM directly when it's live.
